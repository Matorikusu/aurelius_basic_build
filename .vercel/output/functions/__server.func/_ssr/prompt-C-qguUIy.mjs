//#region node_modules/.nitro/vite/services/ssr/assets/prompt-C-qguUIy.js
...
var VOICES = [
	{
		id: "lux",
		name: "Lux",
		quality: "Grounded and quietly wise"
	},
	{
		id: "orion",
		name: "Orion",
		quality: "Rich, cinematic"
	},
	{
		id: "altair",
		name: "Altair",
...
function sanitizeVoice(id) {
	return id && isKnownVoice(id) ? id : "lux";
}
...
//#endregion
export { buildSystemPrompt as a, getSql as c, sanitizeManner as d, sanitizeVoice as f, VOICE_SAMPLE as i, isKnownVoice as l, GREETING as n, ensureDbReady as o, VOICES as r, getPglite as s, DEFAULT_MANNER as t, maxTokensFor as u };
